...
class UserList extends React.Component {
  ...
  render(){
    ...
    <Modal show={this.state.showModal} onHide={this.closeModal.bind(this)}>
              ...
              <Modal.Footer>
              <Button pullLeft bsStyle="success" onClick={this.closeModal.bind(this)}>Confirm</Button>
                <Button pullRight onClick={this.closeModal.bind(this)}>Cancel</Button>
    ...
    if(this.props.users.users){
     ...
     list = this.props.users.users.map((user, index)=>{
      ...
      return (
        ...
        <td>
        <Button bsSize='small' bsStyle='warning' id={user.id}
