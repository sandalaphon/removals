...
var Surveyor = function (_React$Component) {
  _inherits(Surveyor, _React$Component);

  function Surveyor() {
    _classCallCheck(this, Surveyor);

    return _possibleConstructorReturn(this, (Surveyor.__proto__ || Object.getPrototypeOf(Surveyor)).apply(this, arguments));
  }

  _createClass(Surveyor, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'p',
...
var UpdateData = function (_React$Component) {
  _inherits(UpdateData, _React$Component);

  function UpdateData() {
    _classCallCheck(this, UpdateData);

    return _possibleConstructorReturn(this, (UpdateData.__proto__ || Object.getPrototypeOf(UpdateData)).apply(this, arguments));
  }

  _createClass(UpdateData, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'p',
...
//# sourceMappingURL=0.84566afaf944e0ae14ca.hot-update.js.map